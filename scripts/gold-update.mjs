...
if (before.dirty) throw new Error("gold:update requires a clean HEAD; commit or stash changes before measuring");
...
if (after.head !== before.head || after.dirty) throw new Error("gold:update refused because HEAD or worktree changed during measurement");
