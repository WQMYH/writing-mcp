...
try {
  ...
  const report = { schemaVersion: 2, corpus: basename(corpus), parsedChars, measurement: { warmupRunsPerTask: 1, measuredRunsPerTask: 1, percentile: 0.95 }, index: { elapsedMs: indexMs, normalizedMsPerMillionChars: indexPerMillionMs }, explore: { count: exploreLatencies.length, p95Ms: exploreP95Ms }, context: { count: contextLatencies.length, p95Ms: contextP95Ms }, gates: { maxIndexPerMillionMs, maxExploreP95Ms, maxContextP95Ms }, accountingScope: "evidence_excerpts_only", externalTokenResult: "not_evaluated" };
