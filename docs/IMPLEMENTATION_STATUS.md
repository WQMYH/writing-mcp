...
> 当前状态：A1=SourceSnapshot/fingerprint 一致性与恢复；A2=评测实验隔离与只读门禁。当前验证为 144 项测试、lint 0 警告、公共基准 30/30；私有 top-20 历史基线为 40/42、required 15/16，gold @50 候选门禁与 PRF 验收严格区分。response-size、EPUB UTF-8 byte accounting、lifecycle、accountingScope 与 PRF 均已重开，M4 不得宣称完成。
